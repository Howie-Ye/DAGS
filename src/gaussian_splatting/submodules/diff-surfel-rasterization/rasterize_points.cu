...
RasterizeGaussiansCUDA(
	...
	const float transmittance_trunc,
	...
	const bool debug)
{
  ...
  return std::make_tuple(rendered, out_color, out_others, radii, n_touched, geomBuffer, binningBuffer, imgBuffer);
}
	...
	const bool debug) 
{
  ...
  return std::make_tuple(dL_dmeans2D, dL_dcolors, dL_dopacity, dL_dmeans3D, dL_dtransMat, dL_dsh, dL_dscales, dL_drotations, dL_dproj, dL_dview);
}
