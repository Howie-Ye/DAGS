...
class FactorGraph:
    ...
    def rm_keyframe(self, ix):
        ...
        with self.video.get_lock():
            ...
            self.video.prior[ix] = self.video.prior[ix + 1]
    ...
    def update(self, t0=None, t1=None, itrs=2, use_inactive=False, EP=1e-7, motion_only=False):
        ...
        with torch.cuda.amp.autocast(enabled=False):
            ...
            self.video.ba(target, weight, damping, ii, jj, t0, t1,
                          iters=itrs, lm=1e-4, ep=0.1, motion_only=motion_only, opt_type="pose_depth")
    ...
    def add_backend_proximity_factors(self, t_start, t_end, nms, radius, thresh, max_factors, beta, t_start_loop=None,
                                      loop=False):
